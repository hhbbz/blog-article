---
title: Redis简介以及使用场景
date: 2017-09-06 20:28:54
updated: 2018-01-23 23:22:08
categories: 
- 后端
tags:
- Redis
...
{% asset_img 6019b2db-bc3e-4408-b6d8-96025f4481d6.png 图片 %}
...
{% asset_img fb327611-7e2b-4f2f-9f5b-38592d408f07.png 图片 %}
...
{% asset_img cd5fbcff-3f35-43a6-8ffa-082a93ce0f0e.png 图片 %}
...
{% asset_img 7bd202a7-93d4-4f3a-a878-af68ae25539a.png 图片 %}
...
{% asset_img 1202b2d6-9469-4251-bd47-ca6034fb6116.png 图片 %}
...
{% asset_img beba612e-dc5b-4fc2-869d-0b23408ac90a.png %}

在查找时，从上层指针开始查找，找到对应的区间之后再到下一层去查找。例如下图演示了查找 22 的过程。

{% asset_img 0ea37ee2-c224-4c79-b895-e131c6805c40.png %}
...
{% asset_img bee1ff1d-c80f-4b3c-b58c-7073a8896ab2.jpg 图片 %}
...
{% asset_img 9ea86eb5-000a-4281-b948-7b567bd6f1d8.png"/> </div><br>
...
{% asset_img c0a9fa91-da2e-4892-8c9f-80206a6f7047.png 图片 %}
...
{% asset_img 395a9e83-b1a1-4a1d-b170-d081e7bb5bab.png %}
...
{% asset_img 7c54de21-e2ff-402e-bc42-4037de1c1592.png 图片 %}
...
{% asset_img 485fdf34-ccf8-4185-97c6-17374ee719a0.png 图片 %}

## 对文章进行排序

为了按发布时间和点赞数进行排序，可以建立一个文章发布时间的有序集合和一个文章点赞数的有序集合。（下图中的 score 就是这里所说的点赞数；下面所示的有序集合分值并不直接是时间和点赞数，而是根据时间和点赞数间接计算出来的）

{% asset_img f7d170a3-e446-4a64-ac2d-cb95028f81a8.png %}
